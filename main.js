window.addEventListener("load", () => {
  ...
  nextButton.addEventListener("click", () => handleChangeMusic(1));
  prevButton.addEventListener("click", () => handleChangeMusic(-1));

  song.addEventListener("ended", () => handleChangeMusic(1));
